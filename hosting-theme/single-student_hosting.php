<?php
/**
 * Single Student Hosting template.
 *
...
<section style="padding: 60px 0;">
    <div class="container-wrapper">
        ...
        <div style="text-align: center; margin-top: 40px;">
            <a href="<?php echo esc_url( home_url( '/student-hosting/' ) ); ?>" style="display: inline-flex; align-items: center; gap: 8px; color: var(--primary-blue); font-weight: 600; font-size: 15px; text-decoration: none;">
