 ...
 * Description: Reseller Hosting page template for Hostorio theme.
 *
 * @package Hostorio
 */
...
add_action( 'wp_head', function() {
    if ( ! defined( 'WPSEO_VERSION' ) && ! class_exists( 'RankMath' ) ) {
        echo '<meta name="description" content="Reseller hosting for agencies &amp; designers. Unlimited client accounts, white-label, cPanel from ৳1099/mo. Low startup cost, high profit margins. 24/7 support.">' . "\n";
        echo '<link rel="canonical" href="https://hostorio.com/reseller-hosting.html">' . "\n";
        echo '<meta name="robots" content="index, follow">' . "\n";
        echo '<meta property="og:type" content="website">' . "\n";
        echo '<meta property="og:title" content="💼 Start Your Hosting Business – Reseller Hosting Plans | Hostorio">' . "\n";
        echo '<meta property="og:description" content="Launch your hosting business with reseller plans. Unlimited client accounts, white-label branding, cPanel control. High profit margins from ৳1099/mo. Perfect for agencies.">' . "\n";
        ...
        echo '<meta property="og:url" content="https://hostorio.com/reseller-hosting.html">' . "\n";
        echo '<meta name="twitter:card" content="summary_large_image">' . "\n";
        echo '<meta name="twitter:site" content="@hostorio">' . "\n";
        echo '<meta name="twitter:title" content="💼 Start Your Hosting Business – Reseller Hosting Plans | Hostorio">' . "\n";
        echo '<meta name="twitter:description" content="Reseller hosting with unlimited accounts &amp; white-label options. Low startup cost, high margins. From ৳1099/mo. Perfect for agencies &amp; designers.">' . "\n";
    ...
    <script type="application/ld+json">
{
      ...
      "description": "Reseller web hosting plans for agencies, web designers, and freelancers. Create unlimited client accounts with white-label branding options. Includes cPanel, WHM control panel, and 24/7 support. Perfect for starting your own hosting business with low startup costs and high profit margins.",
      "provider": {
        "@type": "Organization",
        "name": "Hostorio",
        "url": "https://hostorio.com"
      ...
      "offers": {
        "@type": "AggregateOffer",
        "url": "https://hostorio.com/reseller-hosting.html",
        "priceCurrency": "BDT",
        "lowPrice": "13188",
        "highPrice": "66000",
        "offerCount": "4",
    ...
    <script type="application/ld+json">
{
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://hostorio.com/reseller-hosting.html"
        }
      ]
    }
    </script>
    <script type="application/ld+json">
{
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How can I start reselling web hosting?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "It's easy – choose one of our reseller hosting packages that fits your needs, complete the purchase, and you'll get instant access to your WHM control panel. From there, you can create unlimited client accounts and start reselling immediately."
          }
        },
        {
          "@type": "Question",
          "name": "Which reseller hosting plan should I choose?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "It depends on your business needs and number of expected clients. Most agencies and designers start with the R-Standard plan as it offers excellent resource allocation and flexibility at a great price point with room to grow."
          }
        },
        {
          "@type": "Question",
          "name": "Can I upgrade my reseller hosting package?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! You can upgrade your reseller hosting package at any time as your business grows. The remaining value from your current plan will be prorated and applied toward the upgraded package, so you never lose money."
          }
        },
        {
          "@type": "Question",
          "name": "Do you provide white-label options for reseller hosting?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! All our reseller hosting plans include white-label options, allowing you to brand the hosting service as your own. Your clients will see your brand, not ours, giving you complete control over your hosting business identity."
          }
        },
        {
          "@type": "Question",
          "name": "Can you help me get started with reseller hosting?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Of course! Our support team is available 24/7 to help you set up your reseller business. We provide documentation, video tutorials, and direct support to ensure you can start reselling hosting quickly and successfully."
          }
        },
        {
          "@type": "Question",
          "name": "How many client accounts can I create with reseller hosting?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "All our reseller hosting plans come with unlimited client account creation. You can create as many cPanel accounts for your clients as you need, limited only by the disk space and bandwidth allocation of your chosen plan."
          }
        }
      ]
    }
    ...
    <div class="package-chooser-wrapper">
        ...
        <div class="content-container">
            <div class="chooser-inner">
                <h1 class="section-headline" data-i18n="resellerHostingHero.headline">Start Your Web Hosting Business Today</h1>
                ...
                <div class="packages-desktop">
                    <div class="top-packages">
                        ...
                        <a href="<?php echo esc_url( hostorio_page_url( 'reseller-hosting' ) ); ?>" class="package-card highlighted">
                            <span class="card-icon">🔄</span>
    ...
    <section class="pricing-section">
        <div class="container-wrapper">
            ...
            <div class="pricing-header">
                <h2 class="pricing-main-title" data-i18n="resellerPricing.mainTitle">Choose Your Reseller Hosting Plan</h2>
                <p class="pricing-subtitle" data-i18n="resellerPricing.subtitle">Everything you need to launch, manage, and scale your business.</p>

                <!-- Billing Toggle -->
                <div class="billing-toggle">
                    <span class="toggle-label" data-i18n="resellerPricing.billedMonthly">Billed Monthly</span>
                    <label class="toggle-switch">
                        <input type="checkbox" id="billingToggle" checked>
                        <span class="toggle-slider"></span>
                    </label>
                    <span class="toggle-label active" data-i18n="resellerPricing.billedAnnually">Billed Annually</span>
                    <span class="save-badge" data-i18n="resellerPricing.saveBadge">Save 30%!</span>
                </div>
            </div>
            ...
            <div class="cloud-pricing-cards">
                ...
                <div class="cloud-card">
                    <div class="cloud-icon">
                        <img src="<?php echo esc_url( HOSTORIO_URI ); ?>/assets/images/pricing/data-server.svg" alt="R-Starter reseller hosting – start your hosting business for agencies">
                    </div>

                    <h3 class="cloud-plan-name" data-i18n="resellerPricing.plans.starter.name">R-Starter</h3>
                    <p class="cloud-plan-desc" data-i18n="resellerPricing.plans.starter.desc">Ideal for beginner</p>

                    <div class="cloud-pricing" data-yearly-price="13188">
                        <div class="cloud-price-original">
                            <span class="orig-currency" data-orig-currency>৳</span><span class="orig-amount"></span>
                            <span class="cloud-save-badge" data-i18n="resellerPricing.saveBadge">Save 30%!</span>
                        </div>
                        <div class="cloud-price-current">
                            <span class="cloud-currency" data-currency-symbol>৳</span>
                            <span class="cloud-amount">1099</span>
                            <span class="cloud-period" data-i18n="resellerPricing.perMonth">/mo</span>
                        </div>
                    </div>
                    ...
                    <ul class="cloud-features">
                        <li>
                            ...
                            <span><strong>20GB</strong> <span data-i18n="resellerPricing.features.ssdStorage">SSD Storage</span></span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span><strong>25</strong> <span data-i18n="resellerPricing.features.cPanelAccounts">cPanel Accounts</span></span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span data-i18n="resellerPricing.features.unlimitedBandwidth">Unlimited Bandwidth</span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span><strong>1</strong> <span data-i18n="resellerPricing.features.ramPerCpanel">GB RAM Per cPanel</span></span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span data-i18n="resellerPricing.features.cpanelWhm">CPanel / WHM Access</span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span data-i18n="resellerPricing.features.whitelabel">100% Whitelabel Servers</span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span data-i18n="resellerPricing.features.softaculousJetbackup">Softaculous + JetBackup</span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span data-i18n="resellerPricing.features.privateNameservers">Private NameServers</span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span data-i18n="resellerPricing.features.freeSSL">FREE SSL Certificate</span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span data-i18n="resellerPricing.features.freeLiteSpeed">FREE LiteSpeed</span>
                        </li>
                    </ul>

                    <a href="#" class="cloud-order-btn" data-i18n="resellerPricing.orderNow">Order Now</a>

                </div>

                <!-- Card 2 - R-Standard (Most Popular) -->
                <div class="cloud-card popular">
                    <div class="cloud-popular-badge" data-i18n="resellerPricing.mostPopular">Most Popular</div>

                    <div class="cloud-icon">
                        <img src="<?php echo esc_url( HOSTORIO_URI ); ?>/assets/images/pricing/data-server.svg" alt="R-Standard reseller plan – white-label hosting with unlimited client accounts">
                    </div>

                    <h3 class="cloud-plan-name" data-i18n="resellerPricing.plans.standard.name">R-Standard</h3>
                    <p class="cloud-plan-desc" data-i18n="resellerPricing.plans.standard.desc">Best for growing resellers</p>
                    ...
                    <ul class="cloud-features">
                        <li>
                            ...
                            <span><strong>50GB</strong> <span data-i18n="resellerPricing.features.ssdStorage">SSD Storage</span></span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span><strong>50</strong> <span data-i18n="resellerPricing.features.cPanelAccounts">cPanel Accounts</span></span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                ...
                <div class="cloud-card">
                    <div class="cloud-icon">
                        <img src="<?php echo esc_url( HOSTORIO_URI ); ?>/assets/images/pricing/data-server.svg" alt="R-Advanced reseller hosting – premium plan for growing hosting businesses">
                    </div>

                    <h3 class="cloud-plan-name" data-i18n="resellerPricing.plans.advanced.name">R-Advanced</h3>
                    <p class="cloud-plan-desc" data-i18n="resellerPricing.plans.advanced.desc">Ideal for established businesses</p>

                    <div class="cloud-pricing" data-yearly-price="34788">
                        <div class="cloud-price-original">
                            <span class="orig-currency" data-orig-currency>৳</span><span class="orig-amount"></span>
                            <span class="cloud-save-badge" data-i18n="resellerPricing.saveBadge">Save 30%!</span>
                        </div>
                        <div class="cloud-price-current">
                            <span class="cloud-currency" data-currency-symbol>৳</span>
                            <span class="cloud-amount">2899</span>
                            <span class="cloud-period" data-i18n="resellerPricing.perMonth">/mo</span>
                        </div>
                    </div>
                    ...
                    <ul class="cloud-features">
                        <li>
                            ...
                            <span><strong>100GB</strong> <span data-i18n="resellerPricing.features.nvmeStorage">NVMe Storage</span></span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span><strong>100</strong> <span data-i18n="resellerPricing.features.cPanelAccounts">cPanel Accounts</span></span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                        ...
                        <li>
                            ...
                            <span data-i18n="resellerPricing.features.freeWhmcs">FREE WHMCS License</span>
                        </li>
                    </ul>
                ...
                <!-- Card 4 - R-Advanced Pro -->
                <div class="cloud-card">
                    <div class="cloud-icon">
                        <img src="<?php echo esc_url( HOSTORIO_URI ); ?>/assets/images/pricing/data-server.svg" alt="R-Advanced Pro reseller – enterprise hosting reseller plan with maximum resources">
                    </div>

                    <h3 class="cloud-plan-name" data-i18n="resellerPricing.plans.advancedPro.name">R-Advanced Pro</h3>
                    <p class="cloud-plan-desc" data-i18n="resellerPricing.plans.advancedPro.desc">Enterprise reseller solution</p>

                    <div class="cloud-pricing" data-yearly-price="66000">
                        <div class="cloud-price-original">
                            <span class="orig-currency" data-orig-currency>৳</span><span class="orig-amount"></span>
                            <span class="cloud-save-badge" data-i18n="resellerPricing.saveBadge">Save 30%!</span>
                        </div>
                        <div class="cloud-price-current">
                            <span class="cloud-currency" data-currency-symbol>৳</span>
                            <span class="cloud-amount">5500</span>
                            <span class="cloud-period" data-i18n="resellerPricing.perMonth">/mo</span>
                        </div>
                    </div>
                    ...
                    <ul class="cloud-features">
                        <li>
                            ...
                            <span><strong>200GB</strong> <span data-i18n="resellerPricing.features.nvmeStorage">NVMe Storage</span></span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
                            ...
                            <span><strong>200</strong> <span data-i18n="resellerPricing.features.cPanelAccounts">cPanel Accounts</span></span>
                        </li>
                        <li>
                            <svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <rect width="16" height="16" rx="3" fill="#E3F2FD"/>
    ...
    <section class="hosting-plans-section">
        <div class="plans-container">
            <div class="plans-header">
                <h2 class="plans-title" data-i18n="comparison.title">Compare Our Reseller Hosting Packages</h2>
            </div>
            ...
            <div class="plans-wrapper">
                ...
                <div class="features-column">
                    ...
                    <div class="feature-list">
                        ...
                        <div class="feature-item-hosting" data-i18n="comparison.features.inodes">cPanel Accounts</div>
                        ...
                        <div class="feature-item-hosting" data-i18n="comparison.features.ram">RAM Per cPanel</div>
                        <div class="feature-item-hosting" data-i18n="comparison.features.freeDomain">Free Domain Name</div>
                        <div class="feature-item-hosting" data-i18n="comparison.features.optimized">cPanel + WHM Access</div>
                        <div class="feature-item-hosting" data-i18n="comparison.features.ssl">100% Whitelabel</div>
                        <div class="feature-item-hosting" data-i18n="comparison.features.litespeedCache">Free SSL</div>
                        <div class="feature-item-hosting" data-i18n="comparison.features.oneClickWP">Free LiteSpeed</div>
                        <div class="feature-item-hosting" data-i18n="comparison.features.subdomains">Softaculous + JetBackup</div>
                        <div class="feature-item-hosting" data-i18n="comparison.features.email">Private NameServers</div>
                        <div class="feature-item-hosting" data-i18n="comparison.features.parked">Unlimited Sub Domains</div>
                        ...
                        <div class="feature-item-hosting" data-i18n="comparison.features.dedicatedIP">Free WHMCS License</div>
                ...
                <div class="plan-column">
                    <div class="plan-header">
                        <h3 class="plan-title">R-Starter</h3>
                    </div>
                    <div class="plan-features">
                        <div class="plan-feature">20 GB SSD</div>
                        <div class="plan-feature">25</div>
                        <div class="plan-feature">Unlimited</div>
                        <div class="plan-feature">BD</div>
                        <div class="plan-feature">1 GB</div>
                        ...
                        <div class="plan-feature plan-pricing-cell">
                            <div class="pricing-box">
                                <div class="price-old">
                                    <span class="strikethrough">৳1,570/mo</span>
                                    <span class="save-badge">Save 30%</span>
                                </div>
                                <div class="price-current">
                                    <span class="price-amount">৳1,099/mo</span>
                                    <span class="price-period"> (৳13,188/yr)</span>
                                </div>
                ...
                <div class="plan-column">
                    <div class="plan-header">
                        <h3 class="plan-title">R-Standard</h3>
                    </div>
                    <div class="plan-features">
                        <div class="plan-feature">50 GB SSD</div>
                ...
                <div class="plan-column">
                    <div class="plan-header">
                        <h3 class="plan-title">R-Advanced</h3>
                    </div>
                    <div class="plan-features">
                        <div class="plan-feature">100 GB NVMe</div>
                        ...
                        <div class="plan-feature plan-pricing-cell">
                            <div class="pricing-box">
                                <div class="price-old">
                                    <span class="strikethrough">৳4,141/mo</span>
                                    <span class="save-badge">Save 30%</span>
                                </div>
                                <div class="price-current">
                                    <span class="price-amount">৳2,899/mo</span>
                                    <span class="price-period"> (৳34,788/yr)</span>
                                </div>
                                <a href="#" class="btn-order">Order Now</a>
                            </div>
                        </div>
                ...
                <!-- Plan 4: R-Advanced Pro -->
                <div class="plan-column">
                    <div class="plan-header">
                        <h3 class="plan-title">R-Advanced Pro</h3>
                    </div>
                    <div class="plan-features">
                        <div class="plan-feature">200 GB NVMe</div>
                        ...
                        <div class="plan-feature plan-pricing-cell">
                            <div class="pricing-box">
                                <div class="price-old">
                                    <span class="strikethrough">৳7,857/mo</span>
                                    <span class="save-badge">Save 30%</span>
                                </div>
                                <div class="price-current">
                                    <span class="price-amount">৳5,500/mo</span>
                                    <span class="price-period"> (৳66,000/yr)</span>
                                </div>
                                <a href="#" class="btn-order">Order Now</a>
                            </div>
                        </div>
    ...
    <div class="testimonial-horizontal-container">
            ...
            <div class="testimonial-horizontal-content">
                ...
                <div class="testimonial-image-side">
                    <div class="testimonial-video-wrapper">
                        <img src="<?php echo esc_url( HOSTORIO_URI ); ?>/assets/images/testimonials/shaidulislamrony.png" alt="Shaidul Islam Rony – reseller hosting customer review" class="testimonial-person-image">
        ...
        <div class="testimonial-horizontal-item">
            <div class="testimonial-horizontal-content">
                ...
                <div class="testimonial-image-side">
                    <div class="testimonial-video-wrapper">
                        <img src="<?php echo esc_url( HOSTORIO_URI ); ?>/assets/images/testimonials/tutul.png" alt="Tutul – satisfied reseller hosting customer" class="testimonial-person-image">
                        <div class="video-play-button">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="play-svg">
                                <path fill="currentColor" d="M8 5v14l11-7z"></path>
                            </svg>
